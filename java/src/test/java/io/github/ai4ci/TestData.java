...
//	}
	...
	@Test
	void testEmpirical() {
		System.out.println(DelayDistribution.fromPDF(0D,0D,1D,2D,2D,1D,1D,1D,1D));
		...
		System.out.println(DelayDistribution.fromPDF(0D,0D,1D,2D,2D,1D,1D,1D,1D).hazard(3));
	}
}
